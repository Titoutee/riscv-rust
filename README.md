...
[![shipthatcode — Build a CPU (RISC-V)](https://api.shipthatcode.com/cert/6db87b531b8ed11576ae59ea477bef74.svg)](https://shipthatcode.com/courses/build-cpu-emulator)

My working repo for [Build a CPU (RISC-V)](https://shipthatcode.com/courses/build-cpu-emulator) on [shipthatcode.com](https://shipthatcode.com) — built lesson by lesson in my own editor.
...
3. In your terminal, inside the unzipped folder, push it to GitHub:
   ...
   git init
   git add .
   git commit -m "start Build a CPU (RISC-V)"
   git branch -M main
   git remote add origin https://github.com/YOUR-USERNAME/YOUR-REPO.git
   git push -u origin main
   ```

4. Paste your repo link on the [course page](https://shipthatcode.com/courses/build-cpu-emulator) ("Work in your own editor" → **Link repo**). Done — you never do this again.
...
Courses improve over time — exercises get added, tests get fixed. If the [course page](https://shipthatcode.com/courses/build-cpu-emulator) says your starter is out of date: download a fresh zip, **delete this repo's `tests/` folder entirely**, copy in the fresh `tests/` and `.shipthatcode.json`, and keep your own code exactly as it is. (Don't merge test folders — lesson numbering can shift between versions.) Lessons you've already completed stay completed either way.
